                  ...
                  <Card className="shadow">
                    <CardHeader className="bg-transparent text-center">
                      <div>
                        ...
                        <h3 className=""><i className="ni ni-email-83 mr-2"></i>Email</h3>
                        <h4 className="mb-3">soen390shop@gmail.com</h4>
                        <h3 className=""><i className="fa fa-phone-square mr-2 "></i>Number</h3>
                ...
                <Col className="" >
                  <Card className="shadow">
                    <CardHeader className="bg-transparent text-center">
                      ...
                      <div>
                        <form>
                          <textarea className="form-control form-control-alternative" rows="5"
                                    placeholder="Enter Suggestion Here ..."></textarea>
                          <Button
                              className="mt-4"
                              color="primary"
